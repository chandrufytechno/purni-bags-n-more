...
<html>
	<head>
	<title>Purni Bags N More :: <?php echo $title; ?> </title>
   <meta charset="utf-8">
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-7 col-md-9">
							<div id="colorlib-logo"><a href="index.php"><img src="images/purnai-n-bags-logo.png" alt="Purnani N Bags" width="150" height="150" class="img-fluid" /></a></div>
						</div>
					...
					<div class="row">
						<div class="col-sm-12 text-left menu-1">
							<ul>
								...
								<li class="has-dropdown"><a href="javascript:void(0)">Brands</a>
									<ul class="dropdown">
								...
								<li class="cart"><a href="javascript:void(0)"><i class="icon-shopping-cart"></i> Cart [0]</a></li>
							</ul>
						</div>
					</div>
				</div>
